    ...
    <div className="mx-2">
      <div className="rounded-lg border border-gray-200 shadow-md overflow-hidden">
        ...
        <div className="w-full h-[300px] md:h-[400px]">
          <iframe
            src="https://www.google.com/maps?q=-9.089521,124.888683&output=embed"
        ...
        <div className="p-4 md:p-6 text-center">
          <p className="text-gray-900 text-lg font-semibold">My Location</p>

          <a
            href="https://maps.app.goo.gl/dDELM1YBfopBVbrS8"
            target="_blank"
